describe("It should allow a user to toggle between light and dark mode", () => {
  ...
  it("toggles to dark mode from every page", () => {
    ...
    cy.get(".dashboard-outermost-wrapper").should(
      "have.css",
      "background-color",
      "rgb(33, 37, 41)"
    );
    ...
    cy.get(".request-meeting-container").should(
      "have.css",
      "background-color",
      "rgb(255, 255, 255)"
    );
