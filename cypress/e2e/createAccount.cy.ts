describe("create account form", () => {
  beforeEach(() => {
    cy.intercept(
      "POST",
      "https://be-experience-exchange-b6ae91ef3c0f.herokuapp.com/api/v1/users/",
      {
        statusCode: 201,
        body: {
          data: {
  ...
  it("should display create account form elements and allow a user to sign up", () => {
    ...
    cy.get('input[name="last_name"]')
      .type("Williams")
      .should("have.value", "Williams");
    cy.get(".email-label").should("have.text", "Email");
    cy.get('input[name="email"]')
      .type("jwilliams@gmail.com")
      .should("have.value", "jwilliams@gmail.com");
    cy.get(".street-label").should("have.text", "Street");
    cy.get('input[name="street"]')
      .type("402 Clinton St.")
      .should("have.value", "402 Clinton St.");
