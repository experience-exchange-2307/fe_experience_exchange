...
function SearchResultCard({
  ...
  return (
    <Link to={`/dashboard/${id}`} style={linkStyle}>
      <div className={`result-card bg-gray-100 hover:bg-gray-300 dark:bg-DRKModeSecondaryBG dark:text-DRKModePrimaryText dark:hover:bg-gray-500 key=${id} ${isDarkMode ? "light" : "dark"}`}>
