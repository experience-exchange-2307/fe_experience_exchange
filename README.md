...
- **Autosuggest Library Not Maintained** We implemented a popular 3rd party [react autosuggest](https://react-autosuggest.js.org/) library.  Some of the errors we encountered were related to legacy class-based components.  This could have been avoided by reading the documentation fully before implementing it.
- **Transitioning from CSS to tailwind** - We added tailwind in the second iteration and had some issues with styling redundancy when switching from CSS to tailwind. We landed on a hybrid of the two and could improve legibility by omitting redundant CSS rules.
